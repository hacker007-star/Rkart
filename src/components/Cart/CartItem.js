...
export default function CartItem({ id, image, title, price, amount }) {
  ...
  return <article className="cart-item">
    ...
    <div>
      ...
      {increaseAmount(id)}}><FaAngleUp></FaAngleUp></button>
      <p className="item-amount">{amount}</p>
      <button type="button" className="cart-btn amount-btn" onClick={() => { decreaseAmount(id,amount)}}><FaAngleDown></FaAngleDown></button>
